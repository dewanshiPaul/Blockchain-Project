...
const Input = ({placeholder, name, type, value, handleChange}) => (
    <input 
        ...
        className='my-2 w-full rouned-sm p-3 outline-none bg-transparent text-white border-none text-sm white-glassmorphism' 
    />
)
        ...
        <div className='flex w-full justify-center items-center'>
            <div className='flex mf:flex-row flex-col justify-between md:p-20 py-12 px-4'>
                ...
                <div className='flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10'>
                    <div className='p-3 justify-end items-start flex-xol rouned-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorphism'>
